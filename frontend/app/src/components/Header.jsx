        ...
        <div className="temhamain1-N1" id="XYmk1ALhP3">
          <div className="header-container container-full">
            <div className="header-left">
              <h1 className="header-title">
                <Link to="/">
                  <img src="/resources/images/medi_logo.png" alt="Medi-best" style={{ height: "75px", width: "auto" }} />
                </Link>
              </h1>
              <nav className="header-gnb desktop-only">
                <ul className="header-gnblist">
                  <li className="header-gnbitem">
                    <Link className="p1 header-gnblink" to="/medicine">
                      <span>의료 정보</span>
                    </Link>
                  </li>
                  <li className="header-gnbitem">
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        ...
        <ul className="mobile-menu-list">
          <li className="mobile-menu-item">
            <Link to="/medicine" onClick={() => setMenuOpen(false)}>의료 정보</Link>
          </li>
          <li className="mobile-menu-item">
